...
const checks = [
  ...
  ["service worker v13", contents["app.js"].includes("serviceWorker.register") && contents["sw.js"].includes("jappo-cotiz-v13")],
...
checks.push(["client Supabase authentifié", contents["index.html"].includes("supabase-client.js?v=10") && contents["supabase-client.js"].includes("Authorization: `Bearer") && contents["app.js"].includes("syncFromBackend")]);
...
checks.push(["écriture limitée par caisse dynamique", contents["supabase/migrations/202607180003_member_fund_schedules.sql"].includes("can_record_fund") && contents["supabase/migrations/202607190007_dynamic_funds_and_due_refresh.sql"].includes("join public.funds fund") && contents["app.js"].includes("fundAccessButtons")]);
...
checks.push(["bouton à jour pour tous les arriérés", contents["index.html"].includes('id="settle-arrears-button"') && contents["app.js"].includes("settlePaymentArrears") && contents["app.js"].includes("Montant global des arriérés")]);
